...
const ASSETS = [
  ...
  './schemes/canopy/cantilever.json',
  './schemes/canopy/between_walls.json',
  './schemes/canopy/free_four_posts.json',
  './schemes/canopy/wall_two_posts.json',
  './schemes/canopy/wall_one_post.json',
  './schemes/canopy/index.json',
  './assets/logo.png',
  './assets/icon-192.png',
  './assets/icon-512.png',
